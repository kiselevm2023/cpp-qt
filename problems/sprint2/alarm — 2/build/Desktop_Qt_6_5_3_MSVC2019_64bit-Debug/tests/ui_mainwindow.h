...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lbl_alarm->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);

        verticalLayout->addWidget(lbl_alarm);
        ...
        lbl_now->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        sb_hour->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        sb_min->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        sb_sec->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        menubar->setContextMenuPolicy(Qt::ContextMenuPolicy::ActionsContextMenu);
